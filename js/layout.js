...
function load_tab(callback) {
    if(oneshot[newTab] == 0) {
        oneshot[newTab] = 1;
        $( "#" + tab_index[newTab] ).html('<div class="spinner" style="position:absolute;top:50%;left:50%;"><div class="bounce1" style="background-color:#2b2922;"></div><div class="bounce2" style="background-color:#2b2922;"></div><div class="bounce3" style="background-color:#2b2922;"></div></div>');
        if(callback) {
